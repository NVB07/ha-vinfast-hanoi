...
const exteriorFeatures = [
    ...
    { image: "5.webp", title: "Logo", desc: "Logo chữ V cách điệu và 2 đường chỉ được mạ crom kéo dài uyển chuyển 2 bên đầu xe" },
    ...
    { image: "8.webp", title: "Cổng sạc", desc: "Thiết kế ngay phía trên hốc bánh xe trước, 2 công sạc riêng biệt cho 2 chế độ sạc khác nhau" },
    ...
    { image: "11.jpg", title: "Cụm đèn hậu", desc: "Sử dụng công nghệ LED, tạo hình chữ V đặc trưng với nhận diện không lẫn vào đâu được" },
];
...
const interiorFeatures = [
    ...
    { image: "16.webp", title: "Hàng ngế sau", desc: "Có không gian để chân vô cùng rộng rãi cho cả 3 người lớn, sàn xe siêu phẳng giúp việc để chân thoải mái hơn" },
    {
        image: "17.webp",
        title: "Khoang hành lý",
        desc: "Với thể tích khá bất ngờ cho mẫu xe hạng A lên tới 260 lít và tăng lên tới 900 lít khi gập phẳng hàng ghế sau",
    },
];
...
const performanceFeatures = [
    {
        image: "18.webp",
        title: "Pin Herio Green",
        desc: "Sử dụng khối pin hiện đại LFP với dung lượng 37,2 KWh, Herio Green cho sự khả năng di chuyển tới 326 km cho mỗi lần sạc đầy pin",
    },
    { image: "19.webp", title: "Động cơ ", desc: "Herio Green sử dụng động cơ điện công suất tới 134 sức ngựa và dẫn động cầu trước tối ưu cho không gian phía sau" },
    {
        image: "20.webp",
        title: "Sạc pin ",
        desc: "Theo công bố của Vinfast, Herio Green có khả năng sạc nhanh từ 10%-70% chỉ trong vòng 33 phút và 18 giờ sạc từ 0-100% đối với sạc thường 2,2 KW",
    },
];
...
const safetyFeatures = [
    ...
    { image: "24.webp", title: "Túi khí", desc: "Với tiêu chuẩn an toàn khắt khe, Herio Green trang bị tới 2 túi khí an toàn cho hàng ghế trước" },
    { image: "25.webp", title: "Cảm biến đỗ xe", desc: "Herio Green được trang bị 4 cảm biến phía sau giúp việc ra vào bãi đỗ trở nên vô cùng an toàn" },
    {
        image: "26.jpg",
...
export default function HERIOGREENDetails({ car }: { car: any }) {
    if (!car || !car.name.toUpperCase().includes("HERIO GREEN")) return null;
        ...
        <div className="container mx-auto px-4 max-w-6xl mt-12 flex flex-col gap-12">
            ...
            <div className="mt-8">
                <div className="flex items-center justify-center gap-4 mb-8">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold uppercase text-gray-800 text-center tracking-wide px-4 whitespace-nowrap">
                        BẢNG GIÁ CÁC PHIÊN BẢN VINFAST HERIO GREEN
                    </h2>
                    <div className="h-px bg-gray-200 flex-1"></div>
                </div>
                ...
                <div className="w-full relative overflow-hidden rounded-2xl flex items-center justify-center min-h-[700px] mb-8 group bg-gray-50">
                    <Image
                        src="/images/cars/HERIOGREEN/details/1.webp"
                        alt="Bảng giá HERIO GREEN"
                        fill
                    ...
                    <div className="relative z-10 bg-white/60 backdrop-blur-md rounded-[2.5rem] shadow-2xl p-6 md:p-8 w-[95%] sm:w-[85%] md:w-[450px] my-10">
                        ...
                        <div className="flex flex-col gap-[9px] md:gap-3 text-[10px] md:text-xs px-2 md:px-0">
                            ...
                            <div className="flex justify-between border-b border-gray-300/40 pb-2">
                                ...
                                <span className="text-gray-800 font-bold w-[60%] text-right">{"326 km"}</span>
                            </div>
                            <div className="flex justify-between border-b border-gray-300/40 pb-2">
                                <span className="text-black font-semibold w-[40%] shrink-0">Thời gian sạc pin 10%-70%:</span>
                                <span className="text-gray-800 font-bold w-[60%] text-right">33 phút</span>
                            </div>
                            <div className="flex justify-between border-b border-gray-300/40 pb-2">
                                <span className="text-black font-semibold w-[40%]">Vành:</span>
                                <span className="text-gray-800 font-bold w-[60%] text-right">Đúc 16 inh</span>
                            </div>
                            <div className="flex justify-between border-b border-gray-300/40 pb-2">
                            ...
                            <div className="flex justify-between border-b border-gray-300/40 pb-2">
                                ...
                                <span className="text-gray-800 font-bold w-[60%] text-right max-w-full">2 túi khí, Cảm biến lùi, Cam lùi</span>
                            </div>
                        </div>
                ...
                <div className="w-full flex justify-center mb-8">
                    <Image
                        src="/images/cars/HERIOGREEN/details/2.webp"
            ...
            <div className="mt-10 mb-8 max-w-5xl mx-auto w-full">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-3 tracking-wide">THIẾT KẾ NGOẠI THẤT VINFAST HERIO GREEN</h2>
                    <h3 className="text-lg md:text-xl font-bold text-[#cc0000] mb-4"> VinFast Herio Green – Vẻ đẹp của sự tối giản</h3>
                    <p className="text-gray-700 leading-relaxed text-[15px] mx-auto md:mx-0">
                        Với thiết kế hiện đại, độc đáo, được trang bị các công nghệ và tính năng thông minh vượt trội, khả năng vận hành mạnh mẽ, an toàn, Herio Green hội
                    ...
                    {exteriorFeatures.map((item, index) => (
                        <div key={index} className="flex flex-col items-center text-center group cursor-pointer">
                            <div className="w-full aspect-[4/3] relative overflow-hidden mb-5 border border-gray-100 shadow-sm rounded-sm">
                                <Image
                                    src={`/images/cars/HERIOGREEN/details/${item.image}`}
                                    alt={item.title}
                                    fill
            ...
            <div className="mt-10 mb-8 max-w-5xl mx-auto w-full">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-3 tracking-wide">THIẾT KẾ NỘI THẤT HERIO GREEN</h2>
                    <h3 className="text-lg md:text-xl font-bold text-[#cc0000] mb-4">Herio Green – Xe cỡ nhỏ nhưng không gian có dư</h3>
                    <p className="text-gray-700 leading-relaxed text-[15px] mx-auto md:mx-0">
                        Thiết kế thông minh và không gian nội thất tối ưu hóa của Herio Green mang lại trải nghiệm di chuyển tiện lợi, đảm bảo sự thoải mái và tiện nghi
                        cho cả 5 chỗ ngồi. Màu sắc nội thất trang nhã, sạch sẽ giúp cả gia đình thoải mái trải nghiệm
                    </p>
                </div>
            ...
            <div className="mt-10 mb-8 max-w-5xl mx-auto w-full">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-3 tracking-wide">KHẢ NĂNG VẬN HÀNH VINFAST HERIO GREEN</h2>
                    <h3 className="text-lg md:text-xl font-bold text-[#cc0000] mb-4">Mạnh mẽ nhất phân khúc A SUV</h3>
                    <p className="text-gray-700 leading-relaxed text-[15px] mx-auto md:mx-0">
                        Với thân hình nhỏ gọn và công suất “không có đối thủ” trong phân khúc, HERIO Green cho trải nghiệm tuyệt vời khi vận hành trong đô thị về sự linh
                        hoạt và lanh lẹ
                    </p>
                </div>
            ...
            <div className="w-full flex justify-center mb-8 max-w-6xl mx-auto px-4">
                <Image
                    src="/images/cars/HERIOGREEN/details/18.webp"
            ...
            <div className="mt-10 mb-16 max-w-5xl mx-auto w-full px-4 md:px-0">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-3 tracking-wide">TRANG BỊ AN TOÀN VINFAST HERIO GREEN</h2>
                    <h3 className="text-lg md:text-xl font-bold text-[#cc0000] mb-4">An tâm là điều Vinfast gửi gắm tới chủ xe Herio Green</h3>
                    <p className="text-gray-700 leading-relaxed text-[15px] mx-auto md:mx-0">
                        Với sứ mệnh sinh ra để di chuyển chủ yếu ở môi trường đô thị, Herio Green cũng được trang bị khá nhiều hệ thống an toàn quan trọng và hiện đại,
