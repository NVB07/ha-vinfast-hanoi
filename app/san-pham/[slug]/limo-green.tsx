...
const exteriorFeatures = [
    { image: "3.jpg", title: "Đầu xe", desc: "Thiết kế kiểu bo tròn, tạo dáng vẻ thân thiện và khí động học cao" },
    { image: "4.jpg", title: "Thân xe", desc: "Dài gần 5m với khoang hành khách lớn, cho người nhìn cảm nhận độ cao lớn của xe" },
    { image: "5.webp", title: "Mâm xe 18 inch", desc: "Được thiết kế kiểu vành thép cơ bản tuy nhiên có phần ốp nhựa bên ngoài hình cánh hoa 2 tone màu rất bắt mắt" },
    {
        image: "6.webp",
        title: "Đuôi xe",
        desc: "Khá hài hoà với kiểu thiết kế mạnh mẽ của tổng thể, đèn led nhận diện kéo dài, có hơi hướng góc cạnh tạo nhận diện đặc trưng",
    },
    { image: "7.jpg", title: "Cản sau", desc: "Khá cầu kỳ với kiểu phối màu hiện đại, cản sau có chi tiết nổi khối giả bô và đèn phản quang theo tiêu chuẩn thế giới" },
    { image: "8.webp", title: "Cụm đèn hậu", desc: "Sử dụng công nghệ Led dải cho hiệu ứng tuyệt đẹp và nhận diện đặc trưng của nhà Vinfast" },
];

const interiorFeatures = [
    { image: "9.jpg", title: "Hàng nghế trước", desc: "Thiết kế theo phong cách thể thao, tựa đầu liền vững chãi" },
    {
        image: "10.webp",
...
const performanceFeatures = [
    {
        image: "12.webp",
        title: "Pin",
        desc: "Sử dụng khối pin hiện đại LFP với dung lượng 42 KWh, LIMO Green cho sự khả năng di chuyển tới 318 km cho mỗi lần sạc đầy pin",
    },
    {
        image: "14.webp",
        title: "Động cơ ",
        desc: "Sử dụng 01 động cơ điện đặt tại cầu trước với công suất 149 sức ngựa, LIMO Green cho thấy sự dư dả về sức mạnh phục vụ tốt mọi nhu cầu thông thường",
    },
    {
        image: "15.webp",
        title: "Sạc pin ",
        desc: "Theo công bố, LIMO Green có thể sạc siêu nhanh trong 18 phút để di chuyển quãng đường 180km. Sạc từ 10-70% trong khoảng 10 tiếng đối với sạc thường",
    },
];
...
const safetyFeatures = [
    ...
    },
    {
        image: "24.webp",
        title: "Túi khí",
        desc: "Khung gầm chắc chắn, tích hợp 4 túi khí bảo vệ toàn diện. Hệ thống an toàn hiện đại gồm: ABS, EBD, BA, ESC, TCS, HAS, ROM, đảm bảo sự yên tâm tối đa cho người lái và hành khách trên mọi cung đường",
    },
    { image: "25.webp", title: "Cảm biến đỗ xe", desc: "LIMO Green được trang bị 4 cảm biến phía sau giúp việc ra vào bãi đỗ trở nên vô cùng an toàn" },
    {
        image: "26.jpg",
...
export default function LIMOGREENDetails({ car }: { car: any }) {
    if (!car || !car.name.toUpperCase().includes("LIMO GREEN")) return null;
        ...
        <div className="container mx-auto px-4 max-w-6xl mt-12 flex flex-col gap-12">
            ...
            <div className="mt-8">
                <div className="flex items-center justify-center gap-4 mb-8">
                    ...
                    <h2 className="text-xl md:text-2xl font-bold uppercase text-gray-800 text-center tracking-wide px-4 whitespace-nowrap">
                        BẢNG GIÁ CÁC PHIÊN BẢN VINFAST LIMO GREEN
                    </h2>
                    <div className="h-px bg-gray-200 flex-1"></div>
                </div>
                ...
                <div className="w-full relative overflow-hidden rounded-2xl flex items-center justify-center min-h-[700px] mb-8 group bg-gray-50">
                    <Image
                        src="/images/cars/LIMOGREEN/details/1.jpg"
                        alt="Bảng giá LIMO GREEN"
                        fill
                    ...
                    <div className="relative z-10 bg-white/60 backdrop-blur-md rounded-[2.5rem] shadow-2xl p-6 md:p-8 w-[95%] sm:w-[85%] md:w-[450px] my-10">
                        <h3 className="text-2xl md:text-3xl font-black uppercase text-gray-800 text-center mb-1 tracking-wide">VINFAST LIMO GREEN</h3>
                ...
                <div className="w-full flex justify-center mb-8">
                    <Image
                        src="/images/cars/LIMOGREEN/details/2.webp"
            ...
            <div className="mt-10 mb-8 max-w-5xl mx-auto w-full">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-3 tracking-wide">THIẾT KẾ NGOẠI THẤT VINFAST LIMO GREEN</h2>
                    <h3 className="text-lg md:text-xl font-bold text-[#cc0000] mb-4">Ngoại hình tương lai vượt trội phân khúc MPV</h3>
                    <p className="text-gray-700 leading-relaxed text-[15px] mx-auto md:mx-0">
                        Là thiết kế mới nhất nhà Vinfast, Limo thể hiện được sự mới mẻ trong thẩm mỹ, thực dụng trong công năng nhưng vẫn đầy quyến rũ với nhiều mục đích
                        sử dụng
                    </p>
                </div>
                    ...
                    {exteriorFeatures.map((item, index) => (
                        <div key={index} className="flex flex-col items-center text-center group cursor-pointer">
                            <div className="w-full aspect-[4/3] relative overflow-hidden mb-5 border border-gray-100 shadow-sm rounded-sm">
                                <Image
                                    src={`/images/cars/LIMOGREEN/details/${item.image}`}
                                    alt={item.title}
                                    fill
            ...
            <div className="mt-10 mb-8 max-w-5xl mx-auto w-full">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-3 tracking-wide">THIẾT KẾ NỘI THẤT VINFAST LIMO GREEN</h2>
                    <h3 className="text-lg md:text-xl font-bold text-[#cc0000] mb-4">Không gian hiện đại, chất liệu cao cấp</h3>
                    <p className="text-gray-700 leading-relaxed text-[15px] mx-auto md:mx-0">
                        Ra đời với mục tiêu chở khách nên về không gian nội thất thì cực kỳ thoáng đãng, kết hợp với kiểu tạo hình tối giản, các mảng khối nhẹ nhàng giúp
                        người ngồi cảm giác dễ chịu thư giãn trong mỗi hành trình
                    </p>
                </div>
            ...
            <div className="mt-10 mb-8 max-w-5xl mx-auto w-full">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-3 tracking-wide">KHẢ NĂNG VẬN HÀNH VINFAST LIMO GREEN</h2>
                    <h3 className="text-lg md:text-xl font-bold text-[#cc0000] mb-4">Vận hành đỉnh cao trong mọi điều kiện</h3>
                    <p className="text-gray-700 leading-relaxed text-[15px] mx-auto md:mx-0">
                        Dù cho là so sánh với mẫu xe nào cùng phân khúc thì LIMO Green luôn cho thấy khả năng vận hành vượt trội, kể cả về sức mạnh động cơ, sự linh hoạt
                        và cả sự đầm chắc, êm ái
                    </p>
                </div>
            ...
            <div className="w-full flex justify-center mb-8 max-w-6xl mx-auto px-4">
                <Image
                    src="/images/cars/LIMOGREEN/details/16.webp"
            ...
            <div className="mt-10 mb-16 max-w-5xl mx-auto w-full px-4 md:px-0">
                <div className="mb-10 text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold uppercase text-gray-800 mb-3 tracking-wide">TRANG BỊ AN TOÀN VINFAST LIMO GREEN</h2>
                    <h3 className="text-lg md:text-xl font-bold text-[#cc0000] mb-4">Những tính năng an toàn chủ động hiện đại đều hiện diện</h3>
                    <p className="text-gray-700 leading-relaxed text-[15px] mx-auto md:mx-0">
                        Trang bị rất nhiều hệ thống cảm biến giúp Limo có khả năng chống lật, hay giữ cho xe luôn theo đúng hành trình một cách an toàn
                    </p>
                </div>
